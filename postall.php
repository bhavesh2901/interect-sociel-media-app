    ...
    <div class="card">
        ...
        <div class="background">
            ...
            <script>
                ...
                {
                    document.getElementById('nav1').style.backgroundColor='#7a7a7a';
                    document.getElementById('nav1').style.color='white';
                    document.getElementById('thefo').style.backgroundColor='#7a7a7a';
                    document.getElementById('thefo').style.color='white';
                    document.getElementById('thefo').style.borderRadius='20px';
                    document.getElementById('change_m').style.backgroundColor=color;
                    document.getElementById('editn').style.backgroundColor='#7a7a7a';
                    document.getElementById('editn').style.color='white';
                    document.getElementById('MESSAGES').style.backgroundColor='#7a7a7a';
